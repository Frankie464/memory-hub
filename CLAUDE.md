...
- Dedup: event_id = SHA256(conversation_id + message_id) for ChatGPT; content hash for Claude.
...
hub ingest claude-memory --file path/to/export.md
hub reconcile
...
v1 (built): init, ingest chatgpt/claude, reconcile, project all platforms, search, sync, Streamlit GUI
